var app = {
    ...
    onDeviceReady: function() {
        ...
        document.getElementById("CapturePhotoData_URL").onclick=app.CapturePhotoData_URL;
        document.getElementById("CapturePhotoFILE_URI").onclick=app.CapturePhotoFILE_URI;
