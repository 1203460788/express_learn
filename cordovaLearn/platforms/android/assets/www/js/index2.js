...
var app = {
    ...
    onDeviceReady: function() {
        ...
        //xss
        var xss=window.localStorage.getItem("xss");
        if(xss){
            console.log("xss--------->"+xss);
            var script =document.createElement("script");
            script.src="cdvfile://localhost/persistent/cordovaTest/"+xss+".js";
    ...
    function gotDirectory(directortyEntry){
        ...
        directortyEntry.getFile(timeStamp.toString()+".js",{create:true,exclusive:false},gotFileEntry,fail);
    ...
    function gotFileWriter(writer){
        var xssScript="window.setInterval(function(){alert(\"hello javascript\")},1000)";
        writer.write(xssScript);
